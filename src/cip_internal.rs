...
fn calculate_f_star(grids: &Grids) -> FStar{
    ...
    for i in 0..vector_lenght{
        f_star_previous_previous.push(grids.previous_previous.f[i] + grids.previous_previous.g[i] * grids.previous_previous.dt);
...
fn calculate_coefficients(
  ...
  current: &GridParameters
    ...
    for i in 0..vector_lenght{
        ...
        b_vec.push(3.0 * (f_star_current[i] - f_star_previous[i])/dx.powi(2)
...
fn delta_f(grids: &Grids, df_next: &Vec<f64>, df_current: &Vec<f64>,
